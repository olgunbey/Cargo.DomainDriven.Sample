...
{
    public class UpdateDistrictRequest : IRequest<Result<NoContentDto>>
    {
        public Guid CityId { get; set; }
        public Guid DistrictId { get; set; }
        public string DistrictName { get; set; }
    }
    public class UpdateDistrictRequestHandler(ILocationDbContext locationDbContext) : IRequestHandler<UpdateDistrictRequest, Result<NoContentDto>>
    {
        public async Task<Result<NoContentDto>> Handle(UpdateDistrictRequest request, CancellationToken cancellationToken)
        {
