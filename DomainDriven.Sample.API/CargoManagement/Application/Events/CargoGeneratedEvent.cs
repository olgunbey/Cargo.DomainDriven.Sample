...
{
    public class CargoGeneratedEvent
    {
        public CargoGeneratedEvent(int customerId, Status status, int employeeId, int orderId, string cargoCode, int companyId, DateTime cargoCreatedDate, DateTime lastUpdatedDate)
        {
