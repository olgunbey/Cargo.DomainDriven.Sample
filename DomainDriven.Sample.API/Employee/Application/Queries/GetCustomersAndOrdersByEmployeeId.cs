...
namespace DomainDriven.Sample.API.Employee.Application.Queries
{
    ...
    public class GetCustomersAndOrdersByEmployeeIdHandler(IEmployeeDbContext employeeDbContext, IEmployeeRedisConsumer employeeRedisConsumer) : IRequestHandler<GetCustomersAndOrdersByEmployeeIdRequest, ResponseDto<List<GetAllSelectedEmloyeeResponseDto>>>
    {
        ...
        {
            var getAllSelectedEmployee = await employeeDbContext.GetDbSet<Domain.Aggregates.SelectedEmployee>().AsNoTracking()
